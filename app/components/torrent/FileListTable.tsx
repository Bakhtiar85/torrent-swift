...
interface FileListTableProps {
    files: TorrentFile[];
    handleFileDownload: (index: number) => void;
}
                                    ...
                                    <td className="w-20 md:w-[120px] px-4 py-4">
                                        {file.progress > 0 && (
                                            <button
                                                ...
                                                className="inline-flex items-center px-1.5 md:px-3 py-0.5 md:py-1.5 text-[10px] md:text-xs font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 disabled:opacity-50 disabled:hover:bg-blue-600 disabled:cursor-not-allowed"
                                            >
                                                Download
                                            </button>
                                        )}
