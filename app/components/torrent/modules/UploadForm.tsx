...
const UploadForm: React.FC<UploadFormProps> = ({
    ...
    <>
        <div id='step-2' className="mb-3 sm:mb-4">
            ...
            <input
                id="torrent-file"
                type="file"
                className="text-xs lg:text-sm hover:shadow-xl text-gray-300 file:mr-4 file:py-1.5 sm:file:py-2 file:px-3 sm:file:px-4 file:rounded-md file:border-0 file:text-xs sm:file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-600 hover:file:bg-blue-200"
        ...
        <div id='step-3' className="mb-3 sm:mb-4">
